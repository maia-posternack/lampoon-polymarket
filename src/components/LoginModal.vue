...
<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 488 512"
  class="google-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
...
width: 20px;
fill: white; /* Ensures it matches the text color */
}
.smaller{
  font-size: 12px;
  color: #8c8c8c;
